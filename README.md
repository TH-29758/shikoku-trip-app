...
持ち物・会計はログインやメンバー登録なしで利用できます。この2文書は第三者も閲覧・編集できる公開共有方式です。アクセス範囲とルール公開・検証手順は [FIREBASE_SETUP.md](FIREBASE_SETUP.md) を参照してください。Vercelへのアプリ公開とは別にFirestoreルールの公開が必要です。
